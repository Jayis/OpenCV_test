...
Mod_OpticalFlowDual_TVL1::Mod_OpticalFlowDual_TVL1()
{
	...
	cout << "using modified Opt Flow... (Harry)\n";
}

void Mod_OpticalFlowDual_TVL1::calc(InputArray _I0, InputArray _I1, InputOutputArray _flow)
{
	calc_part1(_I0, _I1, _flow);
	calc_part2(_flow);	
}

void Mod_OpticalFlowDual_TVL1::calc_part1(InputArray _I0, InputArray _I1, InputOutputArray _flow)
{
    Mat I0 = _I0.getMat();
    Mat I1 = _I1.getMat();
...
void Mod_OpticalFlowDual_TVL1::calc_part2(InputOutputArray _flow)
{
...
void Mod_OpticalFlowDual_TVL1::procSpecScale(int s)
{
	procOneScale(I0s[s], I1s[s], u1s[s], u2s[s]);
}

void Mod_OpticalFlowDual_TVL1::getFlowSpecScale(int s, Mat& output)
{
	Mat uxy[] = {u1s[s], u2s[s]};
    merge(uxy, 2, output);
}

void Mod_OpticalFlowDual_TVL1::getInterpFlowSpecScale(int s, Mat& output)
{
...
void Mod_OpticalFlowDual_TVL1::procOneScale(const Mat_<float>& I0, const Mat_<float>& I1, Mat_<float>& u1, Mat_<float>& u2)
{
...
void Mod_OpticalFlowDual_TVL1::collectGarbage()
{
    I0s.clear();
    I1s.clear();
    u1s.clear();
